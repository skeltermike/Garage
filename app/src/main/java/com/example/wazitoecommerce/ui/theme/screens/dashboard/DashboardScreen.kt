...
fun DashboardScreen(navController: NavHostController){
   Column (modifier = Modifier
      ...
      //TOP APP BAR
      TopAppBar(title = { Text(text = "Hire Cars with as")}
      )
      //END OF TOP APP BAR
      ...
      Row(modifier = Modifier.padding(start=20.dp)) {
         Column {
            ...
            Text(text = "Hire car without worry",
               fontSize = 15.sp)
         }
         Spacer(modifier = Modifier.width(100.dp))

         Image(painter = painterResource(id =R.drawable.mycar),
         ...
         Row {
            Card(modifier = Modifier.size(width = 150.dp, height = 100.dp)
               ...
               Column {
                  ...
                  Text(text = "Luxurious", fontSize = 15.sp,
            ...
            Card(
               ...
               Column {
                  ...
                  Text(text = "Advanture", fontSize = 15.sp,
                     modifier = Modifier.fillMaxWidth(),
                     textAlign = TextAlign.Center)
               }
         ...
         Row {
            ...
            Card(modifier = Modifier.size(width = 150.dp, height = 100.dp)
               ...
               Column {
                  ...
                  Text(text = "View More cars", fontSize = 15.sp,
                     modifier = Modifier.fillMaxWidth(),
                     textAlign = TextAlign.Center)
               }
            ...
            Card(modifier = Modifier
               ...
               Column {
                  ...
                  Text(text = "Family", fontSize = 15.sp,
                     modifier = Modifier.fillMaxWidth(),
                     textAlign = TextAlign.Center)
               }
